    ...
    , m_flags(flags)
{
    ...
    else
    {
        ...
        m_config.showNormalModeKeyStrokes = false;
        m_config.showIndicatorRegion = true;
        m_config.showLineNumbers = true;
        m_config.autoHideCommandRegion = false;
        m_config.cursorLineSolid = true;
        m_config.backgroundFadeTime = 60.0f;
        m_config.backgroundFadeWait = 60.0f;
        m_config.showScrollBar = 1;
        m_config.lineMargins.x = 1;
        m_config.lineMargins.y = 1;
        m_config.widgetMargins.x = 1;
        m_config.widgetMargins.y = 1;
        m_config.shortTabNames = false;
